...
- MCP server (`groundcrew-mcp`) for native Claude tool integration
- 69 unit tests, 90% branch coverage

[Unreleased]: https://github.com/sandeep-alluru/groundcrew/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/sandeep-alluru/groundcrew/releases/tag/v0.1.0
